        ...
        <div class="container-scroller">
                ...
                <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row bg-dark">
                  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center bg-dark">
                    {{-- <a href="" class="navbar-brand text-white">{{ config('app.name', 'Laravel') }}</a> --}}
                    <a class="navbar-brand brand-logo" href="index.html"><img src="{{ asset('storage/images/web/lapakdesa_logo1.png') }}" alt="logo" class="img-fluid"/></a>
                    <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ asset('storage/images/web/lapakdesa_logosmall.png') }}" alt="logo"/></a>
                  </div>
                      ...
                      <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                          ...
                          <div class="nav-profile-text">
                            <p class="mb-1 text-white">{{ Auth::user()->nama }}</p>
                          </div>
                        </a>
                ...
                <div class="container-fluid page-body-wrapper">
                  ...
                  <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="{{ url('/p_admin/dashboard') }}">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="{{ url('/p_admin/transaksi') }}">
